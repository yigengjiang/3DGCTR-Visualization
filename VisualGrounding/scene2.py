...
if __name__ == "__main__":
    ...
    scene_file_path = '/Users/leechina/Coding/3DGCTR-Visualization/VisualGrounding/VG/step123/pointcloud.npy'
    # Load the bounding box data
    box_gt_data = np.load('/Users/leechina/Coding/3DGCTR-Visualization/VisualGrounding/VG/step123/box_gt.npy')  # Replace with your actual file path
